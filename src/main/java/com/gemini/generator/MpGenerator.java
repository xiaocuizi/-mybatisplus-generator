...
public class MpGenerator {
    final static String dirPath = "D://test";
    final static String driverName = "com.mysql.jdbc.Driver";
//    final static String driverName = "com.mysql.cj.jdbc.Driver";
    final static String userName = "root";
    final static String password = "123456";
    final static String url = "jdbc:mysql://127.0.0.1:3306/performance_schema?useUnicode=true&useSSL=false&characterEncoding=utf8";
